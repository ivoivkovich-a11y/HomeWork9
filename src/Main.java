...
//Задание №9
         ...
         float selaryBank = 29000;
         float totalSelary = 0;
         for (int month = 1; month <= 12; month += 1) {
             totalSelary = selaryBank  + totalSelary;
             float percentBank = totalSelary / 100;
             totalSelary = totalSelary + percentBank;
             System.out.println("Месяц " + month + " сумма накоплений равна " + totalSelary + " рублей");
    }
//Задание №10
